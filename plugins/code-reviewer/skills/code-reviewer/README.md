...
- **Built-in PE sub-agents** — `pe-go` (Go/SQL/Lambda), `pe-vue` (Vue/Nuxt/TS), `pe-aws-infra` (CDK/CDKTF/IaC), each with `claude-opus-4-7` and a self-contained three-pass protocol
